...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-tokenturbo-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-tokenturbo-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-tokenturbo-container') return true;
      return (
